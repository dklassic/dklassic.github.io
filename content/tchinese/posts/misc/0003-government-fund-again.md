...
另外值得一提的是去年的通知信中有強調以不更換簡報內容為原則，今年的通知信中則完全沒有相關的強調，只有說如果使用辦公室提供的筆電簡報的話就只能使用當初提交的版本。言下之意大概也等同於鼓勵團隊簡報時可以再根據需求調整跟做一些超出簡報範圍內的展示，所預先提交的簡報檔這樣就比較偏向給評委事前了解的參考資料使用。
