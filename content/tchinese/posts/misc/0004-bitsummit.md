...
東亞知名的幾個遊戲展，大概就是台灣的台北電玩展（TpGS、TGS）、韓國的韓國國際遊戲展示會（Game Star）、日本的東京電玩展（TGS）以及中國的 China Joy，而更獨立導向的大概是台灣的 G8 遊戲展、韓國的釜山遊戲展（BIC）以及中國的核聚變。其中有一個鶴立雞群的展，舉辦於日本京都的 BitSummit。從以往的各種傳聞就聽說過 BitSummit 是一個非常特別的遊戲展，也因此抱持著些許興趣下報名了 BitSummit。所幸也獲選參加資格，就這樣跑了一趟京都旅程。

以結論而言，我可以明言說接下來我會想要每年都參加 BitSummit，可以的話最好是參展者，但即便是商務票來訪也應該不錯。接下來就先從 BitSummit 的活動說明起。

![路邊隨拍](/images/posts/misc/0004/0007.jpg)
...
以個人看法來說，我認為 BitSummit 審查也可以當一個很好的前哨自評。雖然不知道過去幾年的通過率有多高，但今年是 400 搶 100，也就表示能被審查通過的話就大致代表自己是某種意義上的全球前 25%。BitSummit 的評審方式也明顯更重視遊戲的實際內容，除了會要求提供**一刀未剪遊玩影片**而不是預告片以外，會直接要求提供可遊玩遊戲檔案。相較之下如 TGS Selected Indie 80 這種都是直接預告片定勝負，實質上比到的可能主要是預告片的等級而不是遊戲內容的品質，也就反過來說 BitSummit 的通過就已經是對遊戲內容品質的一劑強心針。
...
值得一提的是 BitSummit 似乎是「中、小學生以下免費入場」，也因此有非常多帶著小孩的家長出現，遠比國內遊戲展還要多。這很重要之後會用上。
...
而最後是原則上 BitSummit 是想要鼓勵不會講日文的團隊參加的，也因此會場備有 40 名翻譯志工。與此同時會場也有志工可以暫時性幫你顧攤，原則上最多顧 30 分鐘但基本上單人顧攤的狀況下想要上個廁所或吃個東西應該是綽綽有餘。
...
一般公開日對於大小開發者、有無預先曝光來說就比較沒差了，基本上就是展覽攤位上的吸睛能力為主、適合展場的配置本身決勝負。雖然 BitSummit 整體來說是個非常專注在獨立遊戲上的展覽機會，實務上大約八成的面積是分配在體積顯著比較大的贊助攤位，因此對於隻身參展的獨立遊戲攤位來說，基本上都是路過的玩家隨機玩到的。

![攤位分配](/images/posts/misc/0004/0010.png "就算只計主戰場的三樓展場，審查入選攤位也是極小的面積被贊助攤團團包圍在展場最深處")
...
![試玩群眾](/images/posts/misc/0004/0003.jpg "最好還是說明指示直接內建在遊戲裡或分開螢幕比較好就是")

# 展出檢討

總之算是無事完成了展出，也算是有相當的收穫。除了前述對於展示畫面的自我檢討以外，實際上還有許多有點流水的觀察，以下隨便列點講述。

- 由於前述 BitSummit 似乎有中、小學生以下免費入場的設計，許多家長會帶著小朋友試玩。之前在看《Unpacking》的作者到 BitSummit 使用 Steam Deck 展示的時候，就有提到關於 Steam Deck 的展示效果非常好但小小孩可能用起來會很辛苦。實際上手掌相對嬌小的情況下確實拿著 Steam Deck 比較容易手痠。也好在有這項先知，我已經預先準備好比較小的手把，在遭遇年齡比較小的試玩玩家時就會幫他們換用。
...
- 日本玩家大概有六成會嘗試按右側的按鈕（Xbox B 按鈕）位置當確認，說明指示有寫哪個是確認紐會有幫助。
- 當遊戲刻意設計類比手把不能操作選單時，滿多玩家會以為是選單系統壞掉而不是自然理解要使用十字按鍵操作。
- 如果不特別提醒的話，會忘記要戴耳機的玩家挺多的；相較之下直接把耳機掛在筆電螢幕上的配置反而能自然讓玩家拿起耳機。
...
鴨川酗酒會沒有開始跟結束，沒有正式的約定，就是開發者之間自然地在晚餐後聚集到鴨川河邊。整體來說參加這場酗酒會的開發者以歐美開發者居多，日本開發者偏少或直接融入英文交流圈。而 BitSummit 對歐美開發者來說是一個來日本玩的好藉口，因此有許多開發者也是專程買商務票來玩。有些開發者還會相約去續團唱 K，不過身為隔天還要布展的開發者當然不可能 XD 同時這一喝幾乎都會喝到隔天凌晨，除了會很累以外也會沒有大眾交通工具得走路或者搭計程車回旅館。

而由於自己是興趣使然的開發者，平時也不算認真在認其他開發者的面孔，在這個場合超容易一搭話就突然出現一個超大的抬頭：
...
![又是路邊隨拍](/images/posts/misc/0004/0008.jpg)

總之因為這樣的體驗，我覺得接下來我得每年為了 BitSummit 至少開發一款新遊戲，理想上希望能以參展者身份登場，但又或許買個商務票去找人喝酒聊天就好，是一個相當開眼界的交流機會。而在這個藉口下順便來點小京都旅行、關西觀光也算不錯。

![《換影循跡》獲得 BitSummit 革新獎](/images/posts/misc/0004/0009.jpg "總之最後恭喜《換影循跡》獲得 BitSummit 革新獎！")