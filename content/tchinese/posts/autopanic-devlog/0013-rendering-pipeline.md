...
實際上為了讓景深的效果更好，我還必須讓背景要素的著色器變得更簡單。如果之前有看過[建築著色器出處的那篇文章]({{< ref "/posts/game-design/0003-quick-open-world" >}})，會發現這邊使用的版本更簡略，理由正是因為我只在乎最後顯現出來的成果，所以拔掉細節反而讓我更好控制景深模糊後的成果。
