...
由於開發初期時，大多數測試者都會是認識我的人，也因此我進行任何測試時都會跟測試者講明必須用這個心態。也因此可以從測試者口中聽到非常殘暴，但也真實反映出我作品品質的評論。當[麥威](https://twitter.com/MaxWeiChen)替我測試時說出「玩到想睡」的時候，的確我本人還是受到了心臟爆擊，但也因此才能讓我正視我很容易逃避不當一回事的設計問題。
...
例如說，如果想要調查「台灣玩家」習慣，卻把問卷調查發到「FB 遊戲開發者社群」的話，實際上調查出來的是開發者偏好而不是真正的玩家偏好。那麼這個問卷的代表性就會很低；如果在，如果想要調查「台灣玩家」習慣，選擇在 PTT Steam 板發問卷的話，實際上調查出來的其實會偏重代表會使用 PTT 的玩家。
...
不過也有另一個難題是：設計得很好很縝密的問卷，反過來可能因為太長而讓人懶得填。這就真的沒有很好的方針可以應對了，可以抓內容的平衡，或者是增加完成填寫的誘因，或者如果環境上就是一定會幫你填完就沒關係。外部給予的填寫誘因可以進行抽獎，而確保一定填得完的環境可以是直接找認識的人或付錢給人來幫你測試。
...
盡量列出選項很重要，因為你要想清楚沒被列出的選項是「真的沒有人會選」，還是「**你不希望有人選**」。但我們是來做資料分析的，就算你不希望有人選也該乖乖讓人選。舉例來說目前看到許多問卷都會有遊戲價格的調查，然而卻有一個明確的最低底價，不讓人往下選。覺得沒自信耗盡選項的話，就直接開出一欄自由填寫的「其他」給填答者使用。

而如果在問題中填答者有想要表達的意見卻表達不出來的話，又或者是得用很彆扭的方式回饋，棄填問卷的機率會大增。例如說填答者如果在問卷很前面，就有想要填答的內容被迫只能在問卷最後面的備註欄填寫，這樣應該很惱人吧 XD

## 結果的有效性

統計學有各種檢定可以拿來驗證資料的有效程度，不過真的要解釋清楚各自怎麼運作就已經變成一門大學課程了。在這裡把過去上統計學講義中最重要的幾張投影片偷過來，這幾張圖表會讓你知道你想要對特定資料類型做特定形式的比較時，可以判斷你需要的檢定的方法是什麼：

![Statistics 1](/images/posts/autopanic-devlog/0019/9.png)
![Statistics 2](/images/posts/autopanic-devlog/0019/10.png)
![Statistics 3](/images/posts/autopanic-devlog/0019/11.png)
