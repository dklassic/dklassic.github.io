...
*最後更新於 2026 年 5 月 6 日：* 這裡有關於我的第一款遊戲《***自動混亂***》的常見問題回答！
...
《**自動混亂**》是一個基本上針對 Steam Deck 設計的作品，Steam Deck 可以穩定使用 800p/90FPS 執行這款遊戲。這也代表說只要你的電腦比 Steam Deck 還強的話就應該要能順順跑。
...
《***自動混亂***》目前提供英文與繁體中文的介面與字幕，未來有計畫支援更多語言，但肯定需要一段時間，因為我希望所有語言都能以母語者撰寫，而不是單純翻譯。

<!-- 如果你有興趣製作非官方語言模組，可以在這裡找到更多資訊。 -->

# 《**自動混亂**》支援 PC 雲端存檔嗎？

有的！《**自動混亂**》在 Steam 上支援雲端存檔。有需要的話你也可以在以下位置找到本地資料：
- Windows - `文件\Saved Games\Autopanic`
...
第一款原型是 2020 年四月完成的，但實際開發要到 2020 年五月才開始進行。期間整個專案有多次停滯。
...
歡迎使用透過媒體素材包的聯絡管道或者透過 Discord 發問。