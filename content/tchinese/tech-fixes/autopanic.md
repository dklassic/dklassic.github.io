...
Steam Deck 上遊玩《自動混亂》要透過 Proton 遊玩 Windows 版，之所以如此是因為測試中 Unity 引擎原生輸出的 Linux 版效能更糟，所以透過 Proton 模擬的體驗反而比較好。

整體來說《自動混亂》可以相當穩定地以 60FPS 遊玩，雖然甚至能相當穩定使用 90FPS 遊玩，但要完全鎖定的穩定性的話得進一步啟用「顯示」→「進階」→「CPU 輕量模式」才能確保。
