...
**IF YOU'RE HAVING ANY TECHNICAL ISSUES WITH *Ultra Void*, READ THIS FIRST**
...
*Ultra Void* runs through Proton on Steam Deck instead of a native port, the reason is because Unity's native Linux port runs way worse than emulation through Proton so I just don't bother.
...
*On Steam:*
1. Right-click on *Ultra Void* in your Steam Library
...
7. Ensure Windows 7 compatibility mode is NOT turned on for Ultra Void.exe.
...
11. After that, make sure that your Windows power settings are set for High Performance while running ***Ultra Void***. Ensure that the monitor running the game is connected to your Nvidia graphics video card on the back of your computer.
...
macOS:
`~/Library/Logs/ChosenConcept/UltraVoid/Player.log`
