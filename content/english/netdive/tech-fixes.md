---
title: "NetDive Tech Fixes"
draft: false
enableComments: false
showTip: false
---

**IF YOU'RE HAVING ANY TECHNICAL ISSUES WITH *NetDive*, READ THIS FIRST**
...
*NetDive* runs through Proton on Steam Deck instead of a native port, the reason is because Unity's native Linux port runs way worse than emulation through Proton so I just don't bother.
...
***NetDive*** is generally a CPU heavy game due to its entity count being absurdly high. However if your device is at least more powerful than Steam Deck you should be able to run it just fine.
